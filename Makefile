...
TEST_OBJ := $(OBJ_DIR)/test_RBT.o $(OBJ_DIR)/test_L2_LOB.o $(OBJ_DIR)/test_L3_LOB_order.o $(OBJ_DIR)/test_L3_LOB_query.o $(OBJ_DIR)/test_main.o
...
$(OBJ_DIR)/test_L2_LOB.o: $(TEST_DIR)/test_L2_LOB.cpp | $(OBJ_DIR)
	$(CXX) $(CPP_FLAGS) -c $< -o $@

$(OBJ_DIR)/test_L3_LOB_order.o: $(TEST_DIR)/test_L3_LOB_order.cpp | $(OBJ_DIR)
	$(CXX) $(CPP_FLAGS) -c $< -o $@

$(OBJ_DIR)/test_L3_LOB_query.o: $(TEST_DIR)/test_L3_LOB_query.cpp | $(OBJ_DIR)
	$(CXX) $(CPP_FLAGS) -c $< -o $@

$(OBJ_DIR)/test_main.o: $(TEST_DIR)/test_main.cpp | $(OBJ_DIR)
	$(CXX) $(CPP_FLAGS) -c $< -o $@

$(OBJ_DIR)/LOB_L3_type.o: $(SRC_DIR)/LOB_L3_type.cpp | $(OBJ_DIR)
	$(CXX) $(CPP_FLAGS) -c $< -o $@
